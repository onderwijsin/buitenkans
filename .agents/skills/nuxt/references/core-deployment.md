...
Nuxt is platform-agnostic thanks to [Nitro](https://nitro.build), its server engine. You can deploy
to almost any platform with minimal configuration—Node.js servers, static hosting, serverless
functions, or edge networks.
...
**Recommended when:** User has static-heavy site, needs built-in forms/auth, or prefers Netlify
ecosystem.
...
**Recommended when:** User has existing infrastructure, needs full control, or deploying to
