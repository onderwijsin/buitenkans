...
Build AI chat interfaces with message streams, reasoning, tool calling, and Vercel AI SDK
integration.
...
Collapsible block for AI reasoning / thinking process. Auto-opens during streaming, auto-closes when
done.
...
Text shimmer animation for streaming states. Automatically used by ChatReasoning and ChatTool when
streaming.
