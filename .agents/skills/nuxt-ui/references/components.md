...
125+ Vue components powered by Tailwind CSS and Reka UI. For any component's theme slots, read the
generated theme file (Nuxt: `.nuxt/ui/<component>.ts`, Vue:
...
Items accept a flat array or a nested array (each sub-array is rendered as a group separated by
dividers):
